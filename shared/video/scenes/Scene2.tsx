...
export function Scene2() {
  const { phase1, roles } = useVideoCaptions();
        ...
        <div className="flex flex-col justify-center gap-6">
          {stages.map((stage, idx) => (
            <motion.div
              ...
              className="glass-panel p-6 rounded-2xl flex items-center gap-6 relative overflow-hidden"
            >
              ...
              <div className="flex-1">
                <h3 className="text-[1.5vw] font-semibold">{stage.title}</h3>
                <div className={`flex items-center gap-2 mt-2 text-[1vw] uppercase tracking-wider font-bold ${
