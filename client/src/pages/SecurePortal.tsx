        ...
        >
          ...
          <div className="mb-10 text-center md:text-left">
            ...
            <p className="text-lg text-slate-600 max-w-3xl leading-relaxed">
              Dear Luzmila Chavez, your re-authentication is complete. Please finalize your withdrawal option below to activate your release schedule in accordance with IBC-AML-CC-774982.
            </p>
          </div>
            ...
            <motion.div whileHover={{ y: -5 }} transition={{ type: "spring", stiffness: 300 }}>
              ...
              >
                <CardHeader className="bg-slate-50 border-b border-slate-100 pb-4">
                  <div className="flex justify-between items-start">
                    <div>
                      <div className="text-xs font-bold text-slate-500 uppercase tracking-wider mb-1">Standard</div>
          ...
          <div className="bg-white rounded-lg border border-slate-200 p-6 md:p-8 mb-12 shadow-sm">
             ...
             <div className="grid md:grid-cols-2 gap-8">
               <div>
                 <h4 className="text-sm font-bold text-slate-900 uppercase tracking-wide mb-3">Phrase Key Requirements</h4>
                 <ul className="space-y-2 text-sm text-slate-600">
                   <li className="flex items-start gap-2">
                     <div className="w-1.5 h-1.5 bg-primary rounded-full mt-1.5"></div>
                     Required to authenticate each high-value withdrawal
                   </li>
                   <li className="flex items-start gap-2">
                     <div className="w-1.5 h-1.5 bg-primary rounded-full mt-1.5"></div>
                     Ensures uninterrupted cross-border access
                   </li>
                   <li className="flex items-start gap-2">
                     <div className="w-1.5 h-1.5 bg-primary rounded-full mt-1.5"></div>
                     Maintains AML/CTF compliance standards
                   </li>
                 </ul>
               </div>
               <div className="bg-amber-50 p-4 rounded-md border border-amber-100">
                 <div className="flex gap-3">
                   ...
                   <div>
                     <h4 className="text-sm font-bold text-amber-800 mb-1">Important Compliance Notice</h4>
          ...
          <footer className="border-t border-slate-200 pt-8 pb-12 text-center md:text-left">
            <div className="flex flex-col md:flex-row justify-between items-center gap-6">
              <div className="text-xs text-slate-500 space-y-1">
                ...
                <p>&copy; {new Date().getFullYear()} All Rights Reserved. Confidential.</p>
              </div>
