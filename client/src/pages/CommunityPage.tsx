          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                <Shield className="w-6 h-6 text-[#004182]" />
                <span className="font-bold text-lg text-[#004182] dark:text-blue-400">IBCCF Community</span>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            ...
            <CardContent className="pt-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold">{stats?.members || 0}</p>
                </div>
          ...
          <Card data-testid="card-stat-threads">
            <CardContent className="pt-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-slate-500 text-sm">Discussions</p>
                  <p className="text-3xl font-bold">{stats?.threads || 0}</p>
                </div>
          ...
          <Card data-testid="card-stat-posts">
            <CardContent className="pt-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-slate-500 text-sm">Total Replies</p>
