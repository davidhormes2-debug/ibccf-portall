...
export type WeakAdminPasswordBannerFlags = {
  weakAdminPasswordAllowed: boolean;
  isProduction: boolean;
} | null;

interface Props {
  flags: WeakAdminPasswordBannerFlags;
}

export function WeakAdminPasswordBanner({ flags }: Props) {
  if (!flags?.weakAdminPasswordAllowed) return null;
  ...
  return (
    <div
      ...
      data-testid="banner-weak-admin-password"
    >
