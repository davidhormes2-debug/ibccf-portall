...
export type WeakAdminUsernameBannerFlags = {
  weakAdminUsernameAllowed: boolean;
  isProduction: boolean;
} | null;

interface Props {
  flags: WeakAdminUsernameBannerFlags;
}

export function WeakAdminUsernameBanner({ flags }: Props) {
  if (!flags?.weakAdminUsernameAllowed) return null;
  ...
  return (
    <div
      ...
      data-testid="banner-weak-admin-username"
    >
